...
class PhoneActivity extends FlxState {
	...
	override public function create() {
		...
		numberDisp = new FlxText(0, 0, 0, number).setFormat("OpenSans-Regular.ttf", 96, Colors.BLACK);
		numberDisp.screenCenter(X);
		numberDisp.y = (FlxG.height * 1) / 8;
		add(numberDisp);

		button1 = new FlxText(0, 0, 0, "1").setFormat("OpenSans-Regular.ttf", 128, Colors.BLACK);
		button1.screenCenter(X);
		button1.x -= FlxG.width / 4;
		button1.y = (FlxG.height * 2) / 8;
		add(button1);
		button2 = new FlxText(0, 0, 0, "2").setFormat("OpenSans-Regular.ttf", 128, Colors.BLACK);
		button2.screenCenter(X);
		button2.y = (FlxG.height * 2) / 8;
		add(button2);
		button3 = new FlxText(0, 0, 0, "3").setFormat("OpenSans-Regular.ttf", 128, Colors.BLACK);
		button3.screenCenter(X);
		button3.x += FlxG.width / 4;
		button3.y = (FlxG.height * 2) / 8;
		add(button3);

		button4 = new FlxText(0, 0, 0, "4").setFormat("OpenSans-Regular.ttf", 128, Colors.BLACK);
		button4.screenCenter(X);
		button4.x -= FlxG.width / 4;
		button4.y = (FlxG.height * 3) / 8;
		add(button4);
		button5 = new FlxText(0, 0, 0, "5").setFormat("OpenSans-Regular.ttf", 128, Colors.BLACK);
		button5.screenCenter(X);
		button5.y = (FlxG.height * 3) / 8;
		add(button5);
		button6 = new FlxText(0, 0, 0, "6").setFormat("OpenSans-Regular.ttf", 128, Colors.BLACK);
		button6.screenCenter(X);
		button6.x += FlxG.width / 4;
		button6.y = (FlxG.height * 3) / 8;
		add(button6);

		button7 = new FlxText(0, 0, 0, "7").setFormat("OpenSans-Regular.ttf", 128, Colors.BLACK);
		button7.screenCenter(X);
		button7.x -= FlxG.width / 4;
		button7.y = (FlxG.height * 4) / 8;
		add(button7);
		button8 = new FlxText(0, 0, 0, "8").setFormat("OpenSans-Regular.ttf", 128, Colors.BLACK);
		button8.screenCenter(X);
		button8.y = (FlxG.height * 4) / 8;
		add(button8);
		button9 = new FlxText(0, 0, 0, "9").setFormat("OpenSans-Regular.ttf", 128, Colors.BLACK);
		button9.screenCenter(X);
		button9.x += FlxG.width / 4;
		button9.y = (FlxG.height * 4) / 8;
		add(button9);

		button0 = new FlxText(0, 0, 0, "0").setFormat("OpenSans-Regular.ttf", 128, Colors.BLACK);
		button0.screenCenter(X);
		button0.y = (FlxG.height * 5) / 8;
		add(button0);
		buttonBack = new FlxText(0, 0, 0, "<").setFormat("OpenSans-Regular.ttf", 128, Colors.BLACK);
